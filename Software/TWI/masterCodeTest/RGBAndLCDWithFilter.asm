...
ORANGE:
	.equ ORANGE_CLEAR = 750
	.equ ORANGE_RED = 271
	.equ ORANGE_GREEN = 238
	.equ ORANGE_BLUE = 211

YELLOW:
	.equ YELLOW_CLEAR = 842
	.equ YELLOW_RED = 299
	.equ YELLOW_GREEN = 283
	.equ YELLOW_BLUE = 230

PURPLE:
	.equ PURPLE_CLEAR = 670
	.equ PURPLE_RED = 211
	.equ PURPLE_GREEN = 222
	.equ PURPLE_BLUE = 203

NOTHING:
	.equ NO_SKITTLE_CLEAR = 636
	.equ NO_SKITTLE_RED = 195
	.equ NO_SKITTLE_GREEN = 211
...
COLOR_MATCH:
	...
	ldi ZH, HIGH(RED_DIFF) //Z POINTS TO THE SMALLEST VALUE
	ldi ZL, LOW(RED_DIFF)
