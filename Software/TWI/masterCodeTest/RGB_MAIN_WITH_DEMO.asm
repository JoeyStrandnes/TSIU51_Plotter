...
BOOT://FUSE IS SET TO 64 ms STARTUP
	...
	ldi r16, 29 //NUMBER OF BYTES IN SRAM
...
DEMO:
	...
	push ZL
	push r16
	ldi	ZH, HIGH(2*DEMO_VALUES)
	ldi ZL, LOW(2*DEMO_VALUES)
...
///////DEMO VALUES ///////
DEMO_VALUES:
	//.db 0, 2 , 4 , 3 , 1 , 0 , 1 , 2 , 3 , 4 , 2 , 2 , 1 , 4 , 2 , 4 , 0 , 3 , 1 , 0 , 1 , 2 , 4 , 1
	.db 0, 1, 2, 3, 1 , 3 , 0 , 2 , 4